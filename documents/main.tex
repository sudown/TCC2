...
A abordagem textual (\textit{diff3}) é agnóstica à linguagem, rápida e robusta, mas sofre com a falta de contexto semântico. Já o \textit{Merge Estruturado} \cite{apel2011semistructured} opera sobre a Árvore Sintática Abstrata (AST). Embora elimine conflitos de formatação, o merge estruturado enfrenta barreiras de adoção: alto custo de desenvolvimento de \textit{parsers} e incapacidade de processar arquivos com erros de sintaxe momentâneos.
